...
module("ror")
table5={
   ["p"]={"google-chrome --incognito","google-chrome","incognito","instance"}, 
   ["o"]={"./local/hunter-eclipse64.sh","eclipse"}, 
   ["s"]={"./local/bin/sylpheed","Sylpheed"},
   ["z"]={"zim","Zim"},
   ["F1"]={"google-chrome","google-chrome","private"},
   ["F2"]={"google-chrome","google-chrome","work"},
}
